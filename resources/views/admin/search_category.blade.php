      ...
      <form action="{{URL::to('/search-category')}}" method="POST">
        ...
        <div class="col-sm-3">
          <div class="input-group">
            <input type="text" class="input-sm form-control" placeholder="Tìm kiếm danh mục" name = "keyword">
            <span class="input-group-btn">
             <input type="submit" class="btn btn-sm btn-default" mame = "search_category" value="Tìm kiếm">
            </span>
          </div>
        </div>
      </form>
