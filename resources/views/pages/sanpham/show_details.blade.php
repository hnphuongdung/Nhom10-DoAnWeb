...
<div class="container">
  <div class="row">
   ...
   <div class="col-md-6 col-lg-3 ftco-animate">
    <div class="product">
     <a href="#" class="img-prod"><img class="img-fluid" src="{{URL::to('public/upload/product/'.$lienquan->product_image)}}" alt="Colorlib Template">
     </a>
     <div class="text py-3 pb-4 px-3 text-center">
      <h3><a href="#">{{$lienquan->product_name}}</a></h3>
